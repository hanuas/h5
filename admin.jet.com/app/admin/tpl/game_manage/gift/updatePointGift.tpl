...
<div class="panel panel-default">
        ...
        <br />
        <form role="form" id="linemeta_line" class="form-horizontal text-left" method="post" action="/index.php?m=game_manage&c=gift&a=updateGift&type=point&gift_id=<?php echo $_GET['gift_id']; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <select  style="width:30%" disabled readonly>
                        <option value="0" <?php if($gift_info['point_gift_auto_send'] == 0){echo 'selected';} ?> >否</option>
                        <option value="1" <?php if($gift_info['point_gift_auto_send'] == 1){echo 'selected';} ?> >是</option>
                    </select>
            ...
            <div class="form-group union_code" >
                ...
                <div class="col-sm-10">
                    <p class="form-control-static"><input type="text" name="point" required  class="form-control union_code" value="<?php echo $gift_info['point']; ?>" ></p>
                </div>
            </div>
            <?php if($gift_info['point_gift_auto_send'] == 1){ ?>
            <div class="form-group qq_group_num auto_send"  >
                <label for="sl_must_known" class="col-sm-2 control-label">礼包总量<span style="color:red">*</span></label>
                <div class="col-sm-10">
                    <p class="form-control-static"><input type="text" name="total" required class="form-control"  value="<?php echo $gift_info['total']; ?>" ></p>
                </div>
            </div>
            <?php } ?>
            ...
            <?php if($gift_info['point_gift_auto_send'] == 0){ ?>
