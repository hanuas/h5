...
<div class="panel panel-default">
        ...
        <form role="form" id="linemeta_line" class="form-horizontal text-left" method="post" action="index.php?m=game_manage&c=game&a=updateGame&id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="sl_must_known" class="col-sm-2 control-label">平台游戏地址:</label>
                <div class="col-sm-10">
                    <p class="form-control-static"><?php echo $game_info['game_url']; ?></p>
                </div>
            </div>
            <div class="form-group">
                <label for="sl_must_known" class="col-sm-2 control-label">权重:</label>
                <div class="col-sm-10">
                    <p class="form-control-static"><?php echo $game_info['weight']; ?></p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static">
                        <?php echo $game_info['brief_intro']; ?>
                    </p>
                </div>
            </div>   
            <!--
            ...
            <div class="form-group">
                <label for="sl_must_known" class="col-sm-2 control-label">是否显示微信菜单:</label>
                <div class="col-sm-10">
                    <p class="form-control-static">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static">
                        否&nbsp;&nbsp;<input type="radio" name="is_exclusive" disabled value="0" <?php if($game_info['is_exclusive'] == '0'){echo "checked"; } ?> >
                        是&nbsp;&nbsp;<input type="radio" name="is_exclusive" disabled value="1" <?php if($game_info['is_exclusive'] == '1'){echo "checked"; } ?>>
                    </p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static">
                        否&nbsp;&nbsp;<input type="radio" name="is_gift" disabled value="0" <?php if($game_info['is_gift'] == '0'){echo "checked"; } ?> >
                        是&nbsp;&nbsp;<input type="radio" name="is_gift" disabled value="1" <?php if($game_info['is_gift'] == '1'){echo "checked"; } ?>>
                    </p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static">
                        否&nbsp;&nbsp;<input type="radio" name="is_new" disabled value="0" <?php if($game_info['is_new'] == '0'){echo "checked"; } ?> >
                        是&nbsp;&nbsp;<input type="radio" name="is_new" disabled value="1" <?php if($game_info['is_new'] == '1'){echo "checked"; } ?> >
                    </p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static">
                        否&nbsp;&nbsp;<input type="radio" name="is_hot" disabled value="0" <?php if($game_info['is_hot'] == '0'){echo "checked"; } ?> >
                        是&nbsp;&nbsp;<input type="radio" name="is_hot" disabled value="1" <?php if($game_info['is_hot'] == '1'){echo "checked"; } ?> >
                    </p>
                </div>
            </div>
            <div class="form-group">
