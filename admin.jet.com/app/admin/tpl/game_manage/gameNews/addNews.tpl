...
<div class="panel panel-default">
        ...
        <br />
        <form role="form" id="linemeta_line" class="form-horizontal text-left" method="post" action="index.php?m=game_manage&c=gameNews&a=addGameNews&game_id=<?php echo $_GET['game_id']; ?>" enctype="multipart/form-data">

            <div class="form-group">
                <label for="sl_must_known" class="col-sm-2 control-label">资讯标题<span style="color:red">*</span></label>
                <div class="col-sm-10">
                    <p class="form-control-static"><input type="text" name="title"  class="form-control"  required value="" ></p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static">
                        ...
                        隐藏&nbsp;&nbsp;<input type="radio" name="status" value="0" checked>
                    </p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static"><input type="text" name="weight"  class="form-control"  required value="" ></p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <p class="form-control-static">
                    <textarea type="text" name="content"  class="form-control"  required value="" id="editor"  cols="20" rows="2"></textarea>
                    </p>
                </div>
            </div>
